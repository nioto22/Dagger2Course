...
public class AuthResource<T> {
    // Can get any type of parameter : T
    // In our case it's gonna be a User

    // To change our AuthStatus function of User

    @NonNull
    public final AuthStatus status; // declare in bottom of this class
